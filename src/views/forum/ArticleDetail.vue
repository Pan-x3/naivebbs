    ...
    <div class="container-body article-detail-body" v-if="Object.keys(articleInfo).length > 0">
      ...
      <div class="detail-container">
        ...
        <div class="comment-panel" id="view-comment">
          <CommentList :articleId="articleInfo.articleId" :articleUserId="articleInfo.userId" v-if="articleInfo.articleId"
...
const getArticleDetail = async (articleId) => {
  ...
  articleInfo.value.content = articleInfo.value.content.replace(/<img/g,"<img style='max-width:100%;height:auto;'");
