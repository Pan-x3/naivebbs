<template>
  <div v-show="showEditor" class="edit-post">
    <el-form
      :model="formData"
      :rules="rules"
      ref="formDataRef"
      ...
      <div class="post-setting">
        <el-card :body-style="{ padding: '5px' }">
          ...
          <div class="setting-inner">
            ...
            <el-button
                type="primary"
                :style="{ width: '100%', marginLeft: '5px', marginBottom: '5px' }"
                @click="postHandler"
                >保存</el-button
              >
          </div>
  ...
  <div v-show="!showEditor" class="alert">屏幕宽度不够，无法编辑</div>
</template>
...
const showEditor = ref(document.body.clientWidth >= 768);
const screenWidth = ref();
// 监听屏幕宽度，若小于768px则将showEditor设置为false
